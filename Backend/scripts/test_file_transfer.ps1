...
Terminal 1 (Alice):
-------------------
powershell -NoExit -Command "cd backend; java -cp out com.meshdrop.Main --name Alice --tcp-port 5001 --udp-port 5002"
...
Terminal 2 (Bob):
-----------------
powershell -NoExit -Command "cd backend; java -cp out com.meshdrop.Main --name Bob --tcp-port 5003 --udp-port 5004"
